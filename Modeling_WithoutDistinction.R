...
for(i in 1:ncol(LogReg_Accuracy)){
  dataframes_BBB_Train[[i]] <- droplevels(dataframes_BBB_Train[[i]])
  glm <- glm(final_result ~ ., data = dataframes_BBB_Train[[i]][,-1], family = "binomial")
  glm_predict <- predict(glm, dataframes_BBB_Test[[i]], type = "response")
  glm_predict <- glm_predict > 0.5
  glm_predict[glm_predict == TRUE] <- "Pass"
  glm_predict[glm_predict == FALSE] <- "Fail"
  glm_predict <- as.factor(glm_predict)
  glm_cM <- confusionMatrix(glm_predict, dataframes_BBB_Test[[i]]$final_result)
  LogReg_Accuracy[1,i] <- round(glm_cM$overall[[1]],2)
  LogReg_Fail_Sensitivity[1,i] <- round(glm_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(glm_cM$overall[1])
}
...
for(i in 1:ncol(LogReg_Accuracy)){
  dataframes_DDD_Train[[i]] <- droplevels(dataframes_DDD_Train[[i]])
  glm <- glm(final_result ~ ., data = dataframes_DDD_Train[[i]][,-1], family = "binomial")
  glm_predict <- predict(glm, dataframes_DDD_Test[[i]], type = "response")
  glm_predict <- glm_predict > 0.5
  glm_predict[glm_predict == TRUE] <- "Pass"
  glm_predict[glm_predict == FALSE] <- "Fail"
  glm_predict <- as.factor(glm_predict)
  glm_cM <- confusionMatrix(glm_predict, dataframes_DDD_Test[[i]]$final_result)
  LogReg_Accuracy[2,i] <- round(glm_cM$overall[[1]],2)
  LogReg_Fail_Sensitivity[2,i] <- round(glm_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(glm_cM$overall[1])
}
...
for(i in 1:ncol(LogReg_Accuracy)){
  dataframes_FFF_Train[[i]] <- droplevels(dataframes_FFF_Train[[i]])
  glm <- glm(final_result ~ ., data = dataframes_FFF_Train[[i]][,-1], family = "binomial")
  glm_predict <- predict(glm, dataframes_FFF_Test[[i]], type = "response")
  glm_predict <- glm_predict > 0.5
  glm_predict[glm_predict == TRUE] <- "Pass"
  glm_predict[glm_predict == FALSE] <- "Fail"
  glm_predict <- as.factor(glm_predict)
  glm_cM <- confusionMatrix(glm_predict, dataframes_FFF_Test[[i]]$final_result)
  LogReg_Accuracy[3,i] <- round(glm_cM$overall[[1]],2)
  LogReg_Fail_Sensitivity[3,i] <- round(glm_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(glm_cM$overall[1])
}
summary(glm)
...
for(i in 1:ncol(svm_Accuracy)){
  svm <- svm(final_result ~ ., data = dataframes_BBB_Train[[i]][,-1])
  ...
  svm_Fail_Sensitivity[1,i] <- round(svm_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(svm_cM$overall[1])
}

# Support Vector Machine DDD
for(i in 1:ncol(svm_Accuracy)){
  svm <- svm(final_result ~ ., data = dataframes_DDD_Train[[i]][,-1])
  ...
  svm_Fail_Sensitivity[2,i] <- round(svm_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(svm_cM$overall[1])
}
...
for(i in 1:ncol(svm_Accuracy)){
  svm <- svm(final_result ~ ., data = dataframes_FFF_Train[[i]][,-1])
  ...
  svm_Fail_Sensitivity[3,i] <- round(svm_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(svm_cM$overall[1])
}
...
for(i in 1:ncol(Bayes_Accuracy)){
  Bayes <- naiveBayes(final_result ~ ., data = dataframes_BBB_Train[[i]][,-1])
  ...
  Bayes_Fail_Sensitivity[1,i] <- round(Bayes_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
...
for(i in 1:ncol(Bayes_Accuracy)){
  Bayes <- naiveBayes(final_result ~ ., data = dataframes_DDD_Train[[i]][,-1])
  ...
  Bayes_Fail_Sensitivity[2,i] <- round(Bayes_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(Bayes_cM$overall[1])
}
...
for(i in 1:ncol(Bayes_Accuracy)){
  Bayes <- naiveBayes(final_result ~ ., data = dataframes_FFF_Train[[i]][,-1])
  ...
  Bayes_Fail_Sensitivity[3,i] <- round(Bayes_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(Bayes_cM$overall[1])
}
...
for(i in 1:ncol(RF_Accuracy)){
  RF <- randomForest(final_result ~ ., data = dataframes_BBB_Train[[i]][,-1])
  ...
  RF_Fail_Sensitivity[1,i] <- round(RF_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
...
# Random Forest DDD
for(i in 1:ncol(RF_Accuracy)){
  RF <- randomForest(final_result ~ ., data = dataframes_DDD_Train[[i]][,-1])
  ...
  RF_Fail_Sensitivity[2,i] <- round(RF_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(RF_cM$overall[1])
}
varImpPlot(RF)
...
for(i in 1:ncol(RF_Accuracy)){
  RF <- randomForest(final_result ~ ., data = dataframes_FFF_Train[[i]][,-1])
  ...
  RF_Fail_Sensitivity[3,i] <- round(RF_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(RF_cM$overall[1])
}
...
for(i in 1:ncol(ANN_Accuracy)){
  ANN <- nnet(final_result ~ ., size = 10, data = dataframes_BBB_Train[[i]][-1])
  ...
  ANN_Fail_Sensitivity[1,i] <- round(ANN_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(ANN_cM$overall[1])
}

# Artificial Neural Network DDD
for(i in 1:ncol(ANN_Accuracy)){
  ANN <- nnet(final_result ~ ., size = 10, data = dataframes_DDD_Train[[i]][-1])
  ...
  ANN_Fail_Sensitivity[2,i] <- round(ANN_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(ANN_cM$overall[1])
}

# Artificial Neural Network FFF
for(i in 1:ncol(ANN_Accuracy)){
  ANN <- nnet(final_result ~ ., size = 10, data = dataframes_FFF_Train[[i]][-1])
  ...
  ANN_Fail_Sensitivity[3,i] <- round(ANN_cM$byClass[[1]],2) # Sensitivity "Fail" = The proportion of "Fails" correctly predicted out of total "Fails"
  print(ANN_cM$overall[1])
}
...
write.csv(LogReg_Accuracy, "LogReg_Accuracy_Full.csv")
write.csv(LogReg_Fail_Sensitivity, "LogReg_Fail_Sensitivity_Full.csv")

write.csv(svm_Accuracy, "svm_Accuracy_Full.csv")
write.csv(svm_Fail_Sensitivity, "svm_Fail_Sensitivity_Full.csv")

write.csv(Bayes_Accuracy, "Bayes_Accuracy_Full.csv")
write.csv(Bayes_Fail_Sensitivity, "Bayes_Fail_Sensitivity_Full.csv")

write.csv(RF_Accuracy, "RF_Accuracy_Full.csv")
write.csv(RF_Fail_Sensitivity, "RF_Fail_Sensitivity_Full.csv")

write.csv(ANN_Accuracy, "ANN_Accuracy_Full.csv")
write.csv(ANN_Fail_Sensitivity, "ANN_Fail_Sensitivity_Full.csv")
...
write.csv(LogReg_Accuracy, "LogReg_Accuracy_PartialClicks.csv")
write.csv(LogReg_Fail_Sensitivity, "LogReg_Fail_Sensitivity_PartialClicks.csv")

write.csv(svm_Accuracy, "svm_Accuracy_PartialClicks.csv")
write.csv(svm_Fail_Sensitivity, "svm_Fail_Sensitivity_PartialClicks.csv")

write.csv(Bayes_Accuracy, "Bayes_Accuracy_PartialClicks.csv")
write.csv(Bayes_Fail_Sensitivity, "Bayes_Fail_Sensitivity_PartialClicks.csv")

write.csv(RF_Accuracy, "RF_Accuracy_PartialClicks.csv")
write.csv(RF_Fail_Sensitivity, "RF_Fail_Sensitivity_PartialClicks.csv")


write.csv(ANN_Accuracy, "ANN_Accuracy_PartialClicks.csv")
write.csv(ANN_Fail_Sensitivity, "ANN_Fail_Sensitivity_PartialClicks.csv")
...
write.csv(LogReg_Accuracy, "LogReg_Accuracy_PartialAsgmts.csv")
write.csv(LogReg_Fail_Sensitivity, "LogReg_Fail_Sensitivity_PartialAsgmts.csv")


write.csv(svm_Accuracy, "svm_Accuracy_PartialAsgmts.csv")
write.csv(svm_Fail_Sensitivity, "svm_Fail_Sensitivity_PartialAsgmts.csv")

write.csv(Bayes_Accuracy, "Bayes_Accuracy_PartialAsgmts.csv")
write.csv(Bayes_Fail_Sensitivity, "Bayes_Fail_Sensitivity_PartialAsgmts.csv")

write.csv(RF_Accuracy, "RF_Accuracy_PartialAsgmts.csv")
write.csv(RF_Fail_Sensitivity, "RF_Fail_Sensitivity_PartialAsgmts.csv")

write.csv(ANN_Accuracy, "ANN_Accuracy_PartialAsgmts.csv")
write.csv(ANN_Fail_Sensitivity, "ANN_Fail_Sensitivity_PartialAsgmts.csv")
